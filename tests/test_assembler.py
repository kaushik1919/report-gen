...
class TestStyleFallback:
    ...
    def test_unknown_block_type_skipped_silently(self, assemble, template, profile, plan):
        """Unrecognised block types must not raise; subsequent blocks still render."""
        section = _section(blocks=[
